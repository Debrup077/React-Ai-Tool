...
import QuestionAnswer from './component/QuestionAnswer.jsx'
...
setTimeout(() => {
  scrollToAnswer.current.scrollTop =
    scrollToAnswer.current.scrollHeight;
}, 500);
setLoader(false);
  }
  ...
  return (
    ...
    <div className='grid grid-cols-5 h-screen text-center'>
      ...
      <div className='col-span-4 p-10'>
        <h1 className='text-4xl bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-pink-500'
      ...
      <svg
        aria-hidden="true"
        className="inline w-8 h-8 text-gray-300 animate-spin fill-purple-600"
        viewBox="0 0 100 101"
        fill="none"
    ...
    <span className="sr-only">Loading...</span>
        ...
        <div ref={scrollToAnswer} className='container h-110 overflow-scroll'>
        ...
        <div className='dark:bg-zinc-800 w-1/2 p-1 pr-5 dark:text-white text-zinc-700 bg-red-100 border-red-100 m-auto rounded-4xl
